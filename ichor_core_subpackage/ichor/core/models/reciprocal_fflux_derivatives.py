...
def reciprocal_fflux_derivs_da_df(iatm_idx, jatm_idx, atoms_instance, system_alf):
    ...
    # derivative of one atom (A) w.r.t. feature 1 of atom omega (the atom on which the ALF is centered) da^A_1 / df1, da^A_2 / df1, da^A_3 / df1 
    ...
    # derivative of one atom (A) w.r.t. feature 2 of atom omega (the atom on which the ALF is centered) da^A_1 / df2, da^A_2 / df2, da^A_3 / df2 
    ...
    # derivative of one atom (A) w.r.t. feature 3 of atom omega (the atom on which the ALF is centered) da^A_1 / df3, da^A_2 / df3, da^A_3 / df3 
    ...
    # derivative of one atom (A) w.r.t. feature k of atom omega (the atom on which the ALF is centered) da^A_1 / df_k, da^A_2 / df_k, da^A_3 / df_k 
    feat_idx = 3
