...
def _test_ints(
    ...
    _assert_val_optional(
        int_dir_instance.integration_error, integration_error
    )

    _assert_dict_of_critical_points(
        int_dir_instance.critical_points, critical_points
    )
    _assert_dict_of_critical_points(
    ...
    _assert_val_optional(
        int_dir_instance.iqa_energy_components, iqa_energy_components
    )
...
def test_methanol_ints_dir():
    ...
    reference_critical_points = {
        'C1': [
        CriticalPoint(1, CriticalPointType.Bond, 0.17161777305, 0.29532486222, -0.078719448795, ['O3']),
        CriticalPoint(2, CriticalPointType.Bond, -1.4656467152, 1.3421771542, 0.14289905288, ['H2']),
        CriticalPoint(3, CriticalPointType.Bond, -1.0276384918, -0.51439726513, 1.2182276386, ['H4']),
        CriticalPoint(4, CriticalPointType.Bond, 0.057953654735, 1.2877842647, 1.4658037325, ['H5']),
        ],
        'H2': [
        CriticalPoint(1, CriticalPointType.Bond, -1.4656467152, 1.3421771542, 0.14289905288, ['C1']),
        ],
        'O3': [
        CriticalPoint(1, CriticalPointType.Bond, 0.17161777305, 0.29532486222, -0.078719448795, ['C1']),
        CriticalPoint(2, CriticalPointType.Bond, 1.2574661206, -0.48707600771, -2.5804638375, ['H6']),
        ],
        'H4': [
        CriticalPoint(1, CriticalPointType.Bond, -1.0276384918, -0.51439726513, 1.2182276386, ['C1']),
        ],
        'H5': [
        CriticalPoint(1, CriticalPointType.Bond, 0.057953654735, 1.2877842647, 1.4658037325, ['C1']),
        ],
        'H6': [
        CriticalPoint(1, CriticalPointType.Bond, 1.2574661206, -0.48707600771, -2.5804638375, ['O3']),
        ]
    }
    ...
    reference_properties = {'C1': {'iqa': -38.039986449,
        'q00': 0.54283906397,
 ...
 'O3': {'iqa': -75.433613432,
    ...
    reference_global_spherical_multipoles = {'C1': {'q00': 0.54283906397,
        'q10': -0.35756588345,
        'q11c': 0.48495495846,
        'q11s': -0.088675344388,
        'q20': 0.03424254444,
 ...
 'O3': {'q00': -1.1395979259,
    ...
    referece_local_spherical_multipoles = {'C1': {'q00': 0.54283906397,
        'q10': -0.05767335746841548,
        'q11c': -0.31595336347551817,
        'q11s': 0.5174410549922349,
        'q20': -0.4391729927935119,
 ...
 'O3': {'q00': -1.1395979259,
    ...
    reference_iqa_energy_components = {'C1': {'E_IQA(A)': -38.039986449,
 ...
 'O3': {'E_IQA(A)': -75.433613432,
    ...
    atom_name = {'C1': 'C1', 'H2': 'H2', 'O3': 'O3', 'H4': 'H4', 'H5': 'H5', 'H6': 'H6'},
    atom_num = {'C1': 1, 'H2': 2, 'O3': 3, 'H4': 4, 'H5': 5, 'H6': 6},
    title = {'C1': 'METHANOL_AMBER1000K0', 'H2': 'METHANOL_AMBER1000K0', 'O3': 'METHANOL_AMBER1000K0', 'H4': 'METHANOL_AMBER1000K0', 'H5': 'METHANOL_AMBER1000K0', 'H6': 'METHANOL_AMBER1000K0'},
    dft_model = {'C1': 'Restricted B3LYP', 'H2': 'Restricted B3LYP', 'O3': 'Restricted B3LYP', 'H4': 'Restricted B3LYP', 'H5': 'Restricted B3LYP', 'H6': 'Restricted B3LYP'},
    basin_integration_results = {'C1': {'N': 5.457160936, 'G': 37.243453089, 'K': 37.243325182, 'L': -0.00012790669508, 'WeizKE': 30.38156886, 'TFKE': 33.629384008, 'I': 1.0658987535, '<Rho/r**2>': 136.5315659, '<Rho/r>': 14.554983112, '<Rho*r>': 5.2366290107, '<Rho*r**2>': 7.7663232897, '<Rho*r**4>': 31.619650636, 'GR(-2)': -134.93683828, 'GR(-1)': -26.642078089, 'GR0': -12.303712535, 'GR1': -13.757164071, 'GR2': -25.071415774, 'VenO': -87.329898672, 'VenT': -111.5563367, 'Dipole X': 0.48495495846, 'Dipole Y': -0.088675344388, 'Dipole Z': -0.35756588345, '|Dipole|': 0.60901394849}, 'H2': {'N': 1.0020682526, 'G': 0.59706131492, 'K': 0.59707321472, 'L': 1.1899800117e-05, 'WeizKE': 0.52067998764, 'TFKE': 0.53552847262, 'I': 0.33194247133, '<Rho/r**2>': 2.819912376, '<Rho/r>': 1.2516525659, '<Rho*r>': 1.1526264312, '<Rho*r**2>': 1.7798645754, '<Rho*r**4>': 9.0091280907, 'GR(-2)': -2.2183023471, 'GR(-1)': -1.8344539953, 'GR0': -2.1965361306, 'GR1': -3.5096124874, 'GR2': -7.157503294, 'VenO': -1.2516525659, 'VenT': -6.3994516937, 'Dipole X': 0.1180918724, 'Dipole Y': -0.0738118282, 'Dipole Z': 0.06892703758, '|Dipole|': 0.1553860123}, 'O3': {'N': 9.1395979259, 'G': 75.027380614, 'K': 75.027395266, 'L': 1.4652339007e-05, 'WeizKE': 56.416456093, 'TFKE': 68.298138732, 'I': 1.7437518848, '<Rho/r**2>': 255.14933405, '<Rho/r>': 23.011530736, '<Rho*r>': 9.4063355989, '<Rho*r**2>': 14.400016342, '<Rho*r**4>': 65.083490617, 'GR(-2)': -254.38780343, 'GR(-1)': -44.549648133, 'GR0': -24.493421514, 'GR1': -31.625676166, 'GR2': -59.168257527, 'VenO': -184.09224588, 'VenT': -216.05710946, 'Dipole X': 0.057997397409, 'Dipole Y': 0.049125421029, 'Dipole Z': 0.13401606796, '|Dipole|': 0.15406917787}, 'H4': {'N': 0.99483161085, 'G': 0.60632285703, 'K': 0.6063389124, 'L': 1.6055368633e-05, 'WeizKE': 0.53256922358, 'TFKE': 0.5490728082, 'I': 0.32686610674, '<Rho/r**2>': 2.8777533976, '<Rho/r>': 1.2622876822, '<Rho*r>': 1.1250256692, '<Rho*r**2>': 1.70808964, '<Rho*r**4>': 8.4029025466, 'GR(-2)': -2.247572169, 'GR(-1)': -1.8406733748, 'GR0': -2.1741363038, 'GR1': -3.4174140959, 'GR2': -6.8490803504, 'VenO': -1.2622876822, 'VenT': -6.4259965198, 'Dipole X': 0.062536322511, 'Dipole Y': 0.11768163672, 'Dipole Z': -0.061850406127, '|Dipole|': 0.1469191342}, 'H5': {'N': 0.99227624379, 'G': 0.61689643987, 'K': 0.61692221278, 'L': 2.5772907652e-05, 'WeizKE': 0.53334414083, 'TFKE': 0.55822346953, 'I': 0.32370887475, '<Rho/r**2>': 2.911458585, '<Rho/r>': 1.270654675, '<Rho*r>': 1.1066243449, '<Rho*r**2>': 1.648912242, '<Rho*r**4>': 7.7444114211, 'GR(-2)': -2.2614148567, 'GR(-1)': -1.8357712343, 'GR0': -2.1384208527, 'GR1': -3.3006313816, 'GR2': -6.4780285452, 'VenO': -1.270654675, 'VenT': -6.6047834483, 'Dipole X': -0.065301786036, 'Dipole Y': -0.073855795145, 'Dipole Z': -0.10977823489, '|Dipole|': 0.14754749266}, 'H6': {'N': 0.41410099779, 'G': 0.35125398198, 'K': 0.35127202275, 'L': 1.804077047e-05, 'WeizKE': 0.30417035734, 'TFKE': 0.22382195626, 'I': 0.13793874156, '<Rho/r**2>': 2.0851334394, '<Rho/r>': 0.67793246474, '<Rho*r>': 0.39321731042, '<Rho*r**2>': 0.52993216684, '<Rho*r**4>': 2.1096846512, 'GR(-2)': -1.3783755402, 'GR(-1)': -0.92002171003, 'GR0': -0.91960285898, 'GR1': -1.2665011669, 'GR2': -2.259577981, 'VenO': -0.67793246474, 'VenT': -2.9177723325, 'Dipole X': 0.032679729575, 'Dipole Y': 0.048139646835, 'Dipole Z': 0.15360804702, '|Dipole|': 0.1642584014}},
    integration_error = {'C1': -0.00012790669508, 'H2': 1.1899800117e-05, 'O3': 1.4652339007e-05, 'H4': 1.6055368633e-05, 'H5': 2.5772907652e-05, 'H6': 1.804077047e-05},
    critical_points = reference_critical_points,
    bond_critical_points = reference_bond_critical_points,
    ring_critical_points = {'C1': [], 'H2': [], 'O3': [], 'H4': [], 'H5': [], 'H6': []},
    cage_critical_points = {'C1': [], 'H2': [], 'O3': [], 'H4': [], 'H5': [], 'H6': []},
    properties = reference_properties,
    net_charge = {'C1': 0.54283906397, 'H2': -0.0020682526006, 'O3': -1.1395979259, 'H4': 0.0051683891523, 'H5': 0.0077237562113, 'H6': 0.58589900221},
    ...
    iqa = {'C1': -38.039986449, 'H2': -0.58793326086, 'O3': -75.433613432, 'H4': -0.58903652354, 'H5': -0.58591868462, 'H6': -0.48306665702},
    e_intra = {'C1': -37.437147022, 'H2': -0.46097861755, 'O3': -74.836952161, 'H4': -0.46115204392, 'H5': -0.45733065147, 'H6': -0.29039526201},
    q = {'C1': 0.54283906397, 'H2': -0.0020682526006, 'O3': -1.1395979259, 'H4': 0.0051683891523, 'H5': 0.0077237562113, 'H6': 0.58589900221},
    q00 = {'C1': 0.54283906397, 'H2': -0.0020682526006, 'O3': -1.1395979259, 'H4': 0.0051683891523, 'H5': 0.0077237562113, 'H6': 0.58589900221},
    dipole_mag = {'C1': 0.6090139484811902, 'H2': 0.15538601230071813, 'O3': 0.1540691778681036, 'H4': 0.14691913419419778, 'H5': 0.1475474926644155, 'H6': 0.16425840140398357},
