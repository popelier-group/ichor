        ...
        for ntrain, true, predicted in zip(
            ...
            for type_ in true.keys():
                ...
                for atom in true[type_].keys():
                    df[f"{atom}_{type_} True"] = np.append(
                        true[type_][atom], np.NaN
                    )
                    df[f"{atom}_{type_} Predicted"] = np.append(
                        predicted[type_][atom], np.NaN
                    )
                ...
                df[f"{type_} Total Error"] = np.append(
                    total_error, mean_total_error
                )
