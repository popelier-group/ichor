...
try:
    ...
    from wheel import \
        archive as _wheel_archive  # Not available with wheel >= 0.32.0
    ...
    def run(self, *args, **kwargs):
        ...
        if _USE_WHEELFILE:
            ...
            def update_write_files(wheelfile_self, base_dir):
                with distribution_hide_listing(
                    self.distribution
                ) as hide_listing:
                    if hide_listing:
