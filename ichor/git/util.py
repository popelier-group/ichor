...
from ichor.git.types import (Literal, SupportsIndex, Protocol, runtime_checkable,              # because behind py version guards
...
from ichor.git.ext.gitdb.util import (  # NOQA @IgnorePep8
    make_sha,
