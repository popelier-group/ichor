...
class Repo(object):
    ...
    def __init__(
        ...
        self.working_dir: Optional[PathLike] = (
            self._working_tree_dir or self.common_dir
        )
    ...
    def is_valid_object(
        self, sha: str, object_type: Union[str, None] = None
    ) -> bool:
        try:
    ...
    def blame_incremental(
        self, rev: Union[str, HEAD], file: str, **kwargs: Any
    ) -> Iterator["BlameEntry"]:
    ...
    def blame(
        ...
        **kwargs: Any,
        ...
        List[List[Union[Commit, List[Union[str, bytes]], None]]],
        Iterator[BlameEntry],
        None,
    ]:
    ...
    def archive(
        ...
        **kwargs: Any,
        ...
        path = cast(
            Union[PathLike, List[PathLike], Tuple[PathLike, ...]], path
        )
