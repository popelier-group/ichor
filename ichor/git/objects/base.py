...
from ichor.git.types import Commit_ish, Lit_commit_ish, PathLike
from ichor.git.util import LazyMixin, bin_to_hex, join_path_native, stream_copy
    ...
    def abspath(self) -> PathLike:
        ...
        if self.repo.working_tree_dir is not None:
            ...
            raise WorkTreeRepositoryUnsupported(
                "Working_tree_dir was None or empty"
            )
