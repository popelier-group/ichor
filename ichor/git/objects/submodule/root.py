...
from ichor.git.objects.submodule.base import Submodule, UpdateProgress
from ichor.git.objects.submodule.util import find_first_remote_branch
...
class RootModule(Submodule):
    ...
    def __init__(self, repo: "Repo"):
        ...
        super(RootModule, self).__init__(
            ...
            url="",
            branch_path=ichor.git.Head.to_full_path(self.k_head_default),
        )
                    ...
                    if sm.branch_path != psm.branch_path:
                        ...
                        if not dry_run:
                            ...
                            try:
                                ...
                                tbr = ichor.git.Head(smm, sm.branch_path)
