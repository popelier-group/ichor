...
from ichor.git.objects.base import IndexObject, IndexObjUnion
from ichor.git.objects.blob import Blob
from ichor.git.objects.fun import tree_entries_from_data, tree_to_stream
from ichor.git.objects.submodule.base import Submodule
from ichor.git.types import Literal, PathLike
from ichor.git.util import IterableList, join_path, to_bin_sha
...
class Tree(
    IndexObject, git_diff.Diffable, util.Traversable, util.Serializable
):
