...
class FetchInfo(IterableObj, object):
    ...
    @classmethod
    def _from_line(
        cls, repo: "Repo", line: str, fetch_line: str
    ) -> "FetchInfo":
        ...
        * means birth of new branch or tag
        ...
        if ref_type is SymbolicReference:
            ...
            if remote_local_ref_str.startswith(
...
class Remote(LazyMixin, IterableObj):
    ...
    @classmethod
    def create(
        cls, repo: "Repo", name: str, url: str, **kwargs: Any
    ) -> "Remote":
    ...
    def _get_fetch_info_from_stderr(
        ...
        for err_line, fetch_line in zip(fetch_info_lines, fetch_head_info):
            try:
                ...
                log.warning(
                    "Git informed while fetching: %s", err_line.strip()
                )
        return output
