...
from ichor.git.objects.util import mode_str_to_int
from ichor.git.types import Literal, PathLike
from ichor.git.util import finalize_process, hex_to_bin
...
if TYPE_CHECKING:
    ...
    from ichor.git import Git
    from ichor.git.objects import Commit
    from ichor.git.objects.base import IndexObject
...
class Diffable(object):
    ...
    def _process_diff_args(
        self,
        args: List[Union[str, "Diffable", Type["Diffable.Index"], object]],
    ...
    def diff(
        self,
        other: Union[
            Type["Index"], "Tree", "Commit", None, str, object
        ] = Index,
        paths: Union[
            PathLike, List[PathLike], Tuple[PathLike, ...], None
        ] = None,
        ...
        **kwargs: Any
        ...
        args: List[
            Union[PathLike, Diffable, Type["Diffable.Index"], object]
        ] = []
...
class DiffIndex(List[T_Diff]):
    ...
    def iter_change_type(
        self, change_type: Lit_change_type
    ) -> Iterator[T_Diff]:
        """
        :return:
...
class Diff(object):
    ...
    def _handle_diff_line(
        lines_bytes: bytes, repo: "Repo", index: DiffIndex
    ) -> None:
        ...
        for line in lines.split(":")[1:]:
            ...
            change_type: Lit_change_type = cast(
                Lit_change_type, _change_type[0]
            )
