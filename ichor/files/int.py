...
class INT(GeometryData, File):
    # matt_todo: Is this why the parent argument is needed?
    ...
    :param parent: An `Atoms` instance which holds the coordinate information for all atoms in the system. This information is needed when rotating multipoles.
    """
    ...
    def read_int(self):
        ...
        """ Reads in important things that are needed from .int files (such as IQA energy and multipole moments that were calculated).
        Also multipole moments are rotated here."""
    ...
    def delete(self):
        """ Delete the .int file from disk. """ # matt_todo: Unlinking means that the file is deleted correct?
        self.path.unlink()
    ...
    @cached_property
    def C(self):
        """ A C matrix used to perform rotations."""
    ...
    def rotate_dipole(self):
        """ Rotates dipole moments from Cartesian into spherical coordinates."""
    ...
    def rotate_quadrupole(self):
        """ Rotates quadrupole moments from Cartesian into spherical coordinates."""
    ...
    def rotate_octupole(self):
        """ Rotates octapole moments from Cartesian into spherical coordinates."""
    ...
    @property
    def num(self):
        """ Returns the atom index in the system."""  # matt_todo: I think we should distinguish between the atom number that we use for model files and atom index that is used in python lists
        # because this can cause really annoying problems
    ...
    @property
    def dipole(self):
        """ Returns the dipole moment of the topological atom."""
