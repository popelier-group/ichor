    ...
    def _read_file(self):
        ...
        with open(self.path, "r") as f:
            ...
            for line in f:
                ...
                # have to have this check, otherwise file will not be read correctly
                # this is because once reading has started, FileState is Changed to FileState.Reading
                # then self.version cannot be found because the file has not been fully read yet
                if version_read:
