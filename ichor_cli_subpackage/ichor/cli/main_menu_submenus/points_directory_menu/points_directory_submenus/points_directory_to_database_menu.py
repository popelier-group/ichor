...
POINTS_DIRECTORY_TO_DATABASE_MENU_DESCRIPTION = MenuDescription(
    "Make database from PointsDirectory",
...
points_directory_to_database_items = [
    FunctionItem(
        "Convert PointsDirectory to SQLite3 database.",
