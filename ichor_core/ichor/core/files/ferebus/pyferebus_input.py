...
class PyFerebusScript(WriteFile, File):
    ...
    def set_write_defaults_if_needed(
        ...
        self.nagents = self.nagents or 20
        self.nluckyagents = self.nluckyagents or 2
        self.update_freq = self.update_freq or 50000
        ...
        self.weights_lambda = self.weights_lambda or 1.0e-12
