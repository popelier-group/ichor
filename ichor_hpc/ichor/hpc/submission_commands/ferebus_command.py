...
# class PyferebusCommand(SubmissionCommand):
#     """A class which is used for submitting a pyferebus job for training
...
#         """This loads in the pyferebus virtual environment. The same environment is going to be used
